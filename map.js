...
function view_build_top() {
    d.write('<div class="TopBar">\
		...
		<div class="TopBar_right">\
			...
			<div class="hours" style="float: right;margin-top:1px;margin-right: 121px;"><img src="https://Lands-Warriors.Ru/img/razdor/emerald2.png" width="14" height="14" title="+2 Бонуса"></div>\
		...
		<div class="TopBar_center">\
			<ul class="MainMenu">\
				...
				<li class="TacticMenu">\
					<a href="https://Lands-Warriors.Ru/maps.php?map=1&info=1"  id="TacticMenu" target=_blank class="mainTooltip" onmouseover="tooltip(this,\'<b>Kарта Mира</b>\');" onmouseout="hide_info(this);"></a>\
				</li>\
				<li class="ClanMenu">\
    ...
    /*
        d.write('<div id="header">\
                    ...
                    <div class="hours"><img src="https://Lands-Warriors.Ru/img/razdor/emerald.png" width="14" height="14" title="+1 Изумруд"></div>\
...
function view_build_bottom() {
    ...
    // d.write('<table cellpadding=0 cellspacing=0 border=0 width=100%><tr><td ><img src=https://Lands-Warriors.Ru/img/image/1x1.gif width=1 height=4></td></tr><tr><td align=center>'+view_t()+'</td></tr><tr><td ><img src=https://Lands-Warriors.Ru/img/image/1x1.gif width=1 height=10></td></tr></table>');
}
...
function view_map() {
    ...
    if (!map[0][4].length) {
        ...
        TimerStart((map[0][4][3] - map[0][4][1]), 1);
    }
    else {
        // Работа или защита от подбора
        console.log("work or sec");
        finStatus = 2;
        current_x = map[0][0];
        current_y = map[0][1];
        showCursor();
...
function ButtonGen() {
    var newButtons = ["MovementMenu", "CharacterMenu", "InventoryMenu", "FightMenu", "ClanMenu", "InfoMenu"];
    ...
    for (var i = 0; i < mapbt.length; i++) {
        ...
        switch (mapbt[i][0]) {
            case 'disabled':
                returned += '';
                //   returned += '<img src="https://Lands-Warriors.Ru/img/image/weapon/primanka.png" onclick=\'ButClick("' + (mapbt[i][0] == 'disabled' ? '' : mapbt[i][0]) + '")\' ' + (mapbt[i][0] == 'disabled' ? 'disabled title="У вас нет приманок"' : '') + '></a></div>';
                break;
            case 'dri':
                returned += '<div><img src="https://Lands-Warriors.Ru/img/image/weapon/Vodopad.png" onmouseover="tooltip(this,\'<b>Пить воду</b>\');" onmouseout="hide_info(this);" onclick=\'ButClick("' + (mapbt[i][0] == 'disabled' ? '' : mapbt[i][0]) + '")\' /></div>';
                break;
                ;
            case 'editor':
                returned += '<div><img src="https://Lands-Warriors.Ru/img/image/weapon/admin.png" onmouseover="tooltip(this,\'<b>Админка</b>\');" onmouseout="hide_info(this);" onclick=\'ButClick("' + (mapbt[i][0] == 'disabled' ? '' : mapbt[i][0]) + '")\' /></div>';
                break;
            case 'priman':
                //   returned += '<div><img src="https://Lands-Warriors.Ru/img/image/weapon/primanka.png" onmouseover="tooltip(this,\'<b>Приманка</b>\');" onmouseout="hide_info(this);" onclick=\'ButClick("' + (mapbt[i][0] == 'disabled' ? '' : mapbt[i][0]) + '")\' /></div>';
                break;
            case 'tele':
                returned += '<div><img src="https://Lands-Warriors.Ru/img/image/weapon/teleport.png" onmouseover="tooltip(this,\'<b>Телепорт</b>\');" onmouseout="hide_info(this);" onclick=\'ButClick("' + (mapbt[i][0] == 'disabled' ? '' : mapbt[i][0]) + '")\' /></div>';
                break;
            case 'navi':
                returned += '<div><img src="https://Lands-Warriors.Ru/img/image/weapon/kompas.png" onmouseover="tooltip(this,\'<b>Навигатор</b>\');" onmouseout="hide_info(this);" onclick=\'ButClick("' + (mapbt[i][0] == 'disabled' ? '' : mapbt[i][0]) + '")\' /></div>';
                break;
            case 'ogl':
                returned += '<div><img src="https://Lands-Warriors.Ru/img/image/weapon/travka.png" onmouseover="tooltip(this,\'<b>Поиск травы</b>\');" onmouseout="hide_info(this);" onclick=\'ButClick("' + (mapbt[i][0] == 'disabled' ? '' : mapbt[i][0]) + '")\' /></div>';
                break;
            case 'les':
                returned += '<div><img src="https://Lands-Warriors.Ru/img/image/weapon/drava.png" onmouseover="tooltip(this,\'<b>Поиск леса</b>\');" onmouseout="hide_info(this);" onclick=\'ButClick("' + (mapbt[i][0] == 'disabled' ? '' : mapbt[i][0]) + '")\' /></div>';
                break;
            case 'que':
                $('#InfoMenu')
                    .css("cursor", "pointer")
            ...
            case 'Clan':
                ...
                break;
            case 'fis':
                returned += '<div><img src="https://Lands-Warriors.Ru/img/image/weapon/riba.png" onmouseover="tooltip(this,\'<b>Ловить</b>\');" onmouseout="hide_info(this);" onclick=\'ButClick("' + (mapbt[i][0] == 'disabled' ? '' : mapbt[i][0]) + '")\' /></div>';
                break;
            case 'bld':
            ...
            case 'dep_yes':
                ...
                break;
            default:
                returned += '<div><input type=button class="" style="font-family : Tahoma, Verdana, Arial, Helvetica, Tahoma, Verdana, sans-serif;	text-decoration : none; color : black;	font-size : 11px;" id="' + mapbt[i][0] + '" value="' + mapbt[i][1] + '" onclick=\'ButClick("' + (mapbt[i][0] == 'disabled' ? '' : mapbt[i][0]) + '")\' ' + (mapbt[i][0] == 'disabled' ? 'disabled' : '') + '></div>';
                break;
        }
    }
    //gen bot buttons, workaround
    build_bot_menu();
    return returned;
}
...
//	if(!ButtonSt('', true)){
    ...
    switch (id) {
        case 'nap':
            ...
            break;
        case 'inf':
            goloc = '?get_id=56&act=10&go=inf&vcode=' + bavail[id][0];
            break;
        case 'inv':
            goloc = '?get_id=56&act=10&go=inv&vcode=' + bavail[id][0];
            break;
        case 'ogl':
            Ogl(bavail[id][0]);
            break;
        ...
        case 'fig':
            ...
            break;
        case 'dep_yes':
            goloc = '?get_id=56&act=10&go=dep&vcode=' + bavail[id][0];
            break;
        case 'dep_no':
            Drink(bavail[id][0], 2);
            break;
        case 'editor':
            window.location = '?useaction=map-action&addid=map';
            break;
        case 'dri':
            Drink(bavail[id][0], 1);
            break;
        case 'que':
            ...
            break;
        case 'tele':
            teleMapTo(bavail[id][0]);
            break;
        case 'priman':
            BotNapForm(bavail[id][0]);
            break;
        case 'navi':
            NaviMapTo(bavail[id][0]);
            break;
        case 'bld':
            Building(bavail[id][0], 1, 0);
            break;
    }
    if (goloc) {
...
function build_bot_menu() {
    AjaxGetAsync("map_bots.php?act=1", function (json) {
        let resultHtml = "";
        let bots_array = JSON.parse(json);

        bots_array.forEach(function (bot, index) {
            let styleClass;
            switch (bot["difficulty"]) {
                case "1": //easy
                    styleClass = "bot_menu-easy_bot";
                    break;
                case "2": //medium
                    styleClass = "bot_menu-med_bot";
                    break;
                case "3": //hard
                    styleClass = "bot_menu-hard_bot";
                    break;
                default:
                    styleClass = "";
            }
            ...
            let botHtml =
                "<div class='bot_menu-bot " + styleClass + "' " +
                "onclick='window.location.replace(\"main.php?fight_start=1&bot_id=" + bot["id"] + "&vcode=" + bot["vcode"] + "&csrf_token=" + csrfToken + "\")'" +
                "onmouseover=\"tooltip(this,'<b>" + bot["login"] + "</b>')\"" +
                "onmouseout=\"hide_info(this);\">" +
                "<img alt='Напасть' src='../image/bots/" + bot["icon"] + ".gif'>" +
                "<br><span>" +
                +bot["level"] +
                "</span></div>";

            // Генерация случайного времени задержки от 1 до 80 секунд
            let randomDelay = Math.floor(Math.random() * 1) + 800; // от 1000 до 80000 миллисекунд

            // Установка задержки перед добавлением кнопки в DOM
            setTimeout(function() {
                resultHtml += botHtml;
                d.getElementById("bot_menu").innerHTML = resultHtml;
            }, randomDelay);
        });
    });
}
...
function showMap(x, y) {
    ...
    world.innerHTML = '<div id="bot_menu" class="bot_menu" ></div>';
...
function finFunction() {
    if (moving_status == 1) {
        console.log("reload fin function");
        moving_status = 0;
    ...
    switch (finStatus) {
        ...
        case 1:
            ...
            current_y = map[0][1];
            ButtonSt(false);
            console.log("finfunction called");
            MapReInit(map[1]);
        ...
        case 'FISH':
            ...
            if (ND === false) {
                if (!messb[0]) {
                    ...
                    var tr = 0;
                    var alt;
                    var messal = '<FORM id="FISHF"><table cellpadding=0 cellspacing=0 border=0 width=100%><tr><td bgcolor=#CCCCCC><table cellpadding=3 cellspacing=1 border=0 width=100%>' + (ingr[1] != '00000' ? '<tr><td bgcolor=#FFFFFF colspan=4 class="centr"><img src=https://Lands-Warriors.Ru/img/image/1x1.gif width=1 height=10><br><img src="http://Lands-Warriors.Ru/modules/code/kcaptcha.php?' + ingr[1] + '" width=134 height=60><br><img src=https://Lands-Warriors.Ru/img/image/1x1.gif width=1 height=10><br>Код: <input type=text name=code size=4 class=gr_text id=CAPCODE><br><img src=https://Lands-Warriors.Ru/img/image/1x1.gif width=1 height=10></td></tr>' : '<tr><td bgcolor=#FFFFFF colspan=4 class="centr"><b>Кажется тут можно ловить рыбку!<br>С вашим уровнем навыка вы сможете поймать:</b></td></tr>');
                    ...
                    if (!ingr[2]) {
                        ...
                        for (var b = 0; b < priman.length; b++) {
                            ...
                            messal += '<td bgcolor=#FFFFFF  width=25%><div align=center id=havepriman><font class=nickname><b>' + priman[b][1] + '</b><br> ' + (priman[b][4] < 25 ? '<font class=proce style="color:#006600">(<b>' + priman[b][4] + ' шт.</b>)</font>' : '<font class=proce>(<b>' + priman[b][4] + ' шт.</b>)</font>') + '</font></div><div align=center><img src="https://Lands-Warriors.Ru/img/image/weapon/' + priman[b][2] + '" onmouseover="tooltip(this,\'<b><font color=#336699>Щелкните по изображению для просмотра подробной информации о предмете.</font></b>\')" onmouseout="hide_info(this)" onclick="window.open(\'http://Lands-Warriors.Ru/iteminfo.php?' + priman[b][1] + '\');" style="cursor:pointer;"></div><div align=center><input type=radio name=selectprim value="' + priman[b][0] + '" onClick="javascript: writebut(this.value,\'' + priman[b][3] + '\',\'' + ingr[2] + '\');"></div></td>';
                            if (tr2 == 4) {
                                messal += '</tr>';
                                tr2 = 0;
                            }
                        ...
                        case 0:
                            ...
                            while (fx <= 22 && fy <= 20) {
                                ...
                                if (in_array(ingr, fx, fy)) {
                                    ...
                                    messal += '<td bgcolor=#FFFFFF width=25%><div align=center><img src="https://Lands-Warriors.Ru/img/image/wmap/map/day/' + fy + '/' + fx + '_' + fy + '.gif" width=50 height=50 onclick="javascript: moveMapToNavi(' + fx + ', ' + fy + ',\'' + ingr[i][2] + '\');RemoveDialogDiv();" style="cursor:pointer;" title="' + (ingr[i][3] ? ingr[i][3] : 'Идти сюда') + '"></div></td>';
                                }
                                else {
                                    messal += '<td bgcolor=#FFFFFF width=25%><div align=center><img src="https://Lands-Warriors.Ru/img/image/wmap/map/night/' + fy + '/' + fx + '_' + fy + '.gif" width=50 height=50 title="прохода нет" onclick="javascript: moveMapToNavi(' + fx + ', ' + fy + ',\'\');RemoveDialogDiv();"></div></td>';
                                }
                                fx++;
                                if (fx > 22) {
                                    fx = 1;
...
function TimerStart(secgo, mrinit) {
    // mrinit = true; //temporary fix. always reinit map
...
function timerst(lp) {
    console.log("timerst called");
    time_left_sec -= 1000;
    if (time_left_sec <= 0) {
        if (lp) {
            ButtonSt(false);
            console.log("timerst inner inner");
            MapReInit(map[1]);
            finStatus = 0;
            console.log("reload timerst");
            window.location.reload(); //temporary fix. hard reload all map
        }
        console.log("timerst inner");
...
function LesStart(gid, vcode, serp) {
    setTimeout(function () {
        AjaxGet('les_ajax.php?act=2&gid=' + gid + '&vcode=' + vcode + '&serp=' + serp + '&r=' + Math.random())
    }, tt[5] * 1000);
    TimerStart((tt[5] * 1), 0);
}
...
function shaStart(gid, vcode, serp) {
    setTimeout(function () {
        AjaxGet('sha_ajax.php?act=2&gid=' + gid + '&vcode=' + vcode + '&serp=' + serp + '&r=' + Math.random())
    }, tt[5] * 1000);
    TimerStart((tt[5] * 1), 0);
}
...
function Les(code) {
    setTimeout(function () {
        AjaxGet('les_ajax.php?act=1&vcode=' + code + '&r=' + Math.random())
    }, tt[4] * 1000);
    TimerStart(tt[4], 0);
}
...
function sha(code) {
    setTimeout(function () {
        AjaxGet('sha_ajax.php?act=1&vcode=' + code + '&r=' + Math.random())
    }, tt[4] * 1000);
    TimerStart(tt[4], 0);
}
...
ShowUser = function (user, type) {
    if (type) {
        ...
        return "<a href=\"javascript:parent.say_private('" + user[1] + "')\"><img src=https://Lands-Warriors.Ru/img/image/chat/private.gif width=11 height=12 border=0 align=absmiddle></a>&nbsp;<font class=nick>" + sh_align(user[3], 0) + sh_sign(user[4], user[5], user[6]) + "<B>" + user[1] + "</B>[" + user[2] + "]&nbsp;</font><a href=\"/pinfo.cgi?" + user[1] + "\" target=_blank><img src=https://Lands-Warriors.Ru/img/image/chat/info.gif width=11 height=12 border=0 align=absmiddle></a>";
    }
}
